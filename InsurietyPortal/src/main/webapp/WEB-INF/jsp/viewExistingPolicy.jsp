    ...
    <main id="create-policy-page-content">
        <div class= "container" style="overflow-x: auto;">
            ...
            <table class="menu-table" id="menu-table">
				...
				<form:form name="viewPolicy" modelAttribute="viewPolicy" method="post"  action="/viewPolicy" onsubmit="return validatePolicyForm()">
                <tr class="form-group-name">
                    <td><form:label path="consumerid">Consumer ID:</form:label></td>
                    <td><form:input path="consumerid" name="consumerId" type="number" id="consumerid" required="required"/></td>
                    <td><form:errors path="consumerid" ></form:errors></td>
                </tr>
                <tr class="form-group-name">
         
                        <td><form:label path="policyid" type="text" class="detials-label" >Policy ID:</form:label><br/></td>
                        <td><form:input path="policyid" name="policyId" type="text" required="required"/></td>
